...
<head>
  ...
  <title>Buat Akun - Ketua - Asosiasi Web Programmer</title>
            ...
            <div class="col-md-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Mendaftarkan Akun untuk Anggota Baru</h6>
                </div>

                <div class="card-body">

                  <form class="user" action="../../controller/admin/buat_akun.php" method="post">
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="nik" title="NIK Anda" placeholder="NIK">
                      </div>
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        <select class="form-control" name="hakakses" title="Hak Akses User">
                          <option value="4" selected="">Anggota</option>
                    ...
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="nama" title="Nama Anda" placeholder="Nama">
                      </div>
                      <div class="col-sm-6">
                        <input type="date" class="form-control form-control-user" name="ttl" title="Tanggal Lahir Anda">
                      </div>
                    </div>
                    <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="provinsi" placeholder="Provinsi" title="Provinsi Anda">
                      </div>
                      <div class="col-sm-6">
                        <input type="text" class="form-control form-control-user" name="alamat" placeholder="Alamat" title="Alamat Anda">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                    ...
                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" name="email" placeholder="Alamat Email" title="Alamat Email Anda">
                    </div>
