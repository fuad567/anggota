...
<head>
  ...
  <title>Dashboard - Ketua - Asosiasi Web Programmer</title>
...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="row">
            ...
            <?php
              ...
              // menampilkan data anggota per provinsi (4 provinsi)
              $jateng = "SELECT * FROM `pengguna` WHERE provinsi = 'Jawa Tengah'";
              $jatim = "SELECT * FROM `pengguna` WHERE provinsi = 'Jawa Timur'";
              $jabar = "SELECT * FROM `pengguna` WHERE provinsi = 'Jawa Barat'";
              $jakarta = "SELECT * FROM `pengguna` WHERE provinsi = 'DKI Jakarta'";
              $provlain = "SELECT * FROM `pengguna` WHERE `provinsi` NOT LIKE 'Jawa Tengah' AND `provinsi` NOT LIKE 'Jawa Timur' AND `provinsi` NOT LIKE 'Jawa Barat' AND `provinsi` NOT LIKE 'DKI Jakarta'";

              $jml_jateng = mysqli_num_rows(mysqli_query($db, $jateng));
              $jml_jatim = mysqli_num_rows(mysqli_query($db, $jatim));
              $jml_jabar = mysqli_num_rows(mysqli_query($db, $jabar));
              $jml_jakarta = mysqli_num_rows(mysqli_query($db, $jakarta));
              $jml_provlain = mysqli_num_rows(mysqli_query($db, $provlain));
            ...
            <div class="col-md-12 mb-3">
              ...
              <div class="card shadow mb-2">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Data Jumlah Anggota Per Provinsi</h6>
                </div>
            ...
            <div class="col-md-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <p><b>Status Anggota : <span style="color:green">Ketua</span></b></p>
                  <p>Anda memiliki hak akses untuk melakukan melihat Jumlah data Pendaftar Anggota, Anggota, Statistik Jumlah Anggota Per Bulan, dan Jumlah Anggota Per Provinsi.</p>
                </div>
  ...
  $jan = "SELECT created FROM `pengguna` WHERE created like '$tahun-01-%'";
  $feb = "SELECT created FROM `pengguna` WHERE created like '$tahun-02-%'";
  $mar = "SELECT created FROM `pengguna` WHERE created like '$tahun-03-%'";
  $apr = "SELECT created FROM `pengguna` WHERE created like '$tahun-04-%'";
  $mei = "SELECT created FROM `pengguna` WHERE created like '$tahun-05-%'";
  $jun = "SELECT created FROM `pengguna` WHERE created like '$tahun-06-%'";
  $jul = "SELECT created FROM `pengguna` WHERE created like '$tahun-07-%'";
  $ags = "SELECT created FROM `pengguna` WHERE created like '$tahun-08-%'";
  $sep = "SELECT created FROM `pengguna` WHERE created like '$tahun-09-%'";
  $okt = "SELECT created FROM `pengguna` WHERE created like '$tahun-10-%'";
  $nov = "SELECT created FROM `pengguna` WHERE created like '$tahun-11-%'";
  $des = "SELECT created FROM `pengguna` WHERE created like '$tahun-12-%'";
