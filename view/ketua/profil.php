...
<head>
  ...
  <title>Profil - Ketua - Asosiasi Web Programmer</title>
            ...
            <div class="col-md-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form class="user" action="../../controller/ketua/update_profil.php" method="post">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="nama" title="Nama Anda" value="<?=$row['nama'];?>" placeholder="Nama">
                      </div>
                      <div class="col-sm-6">
                        <input type="date" class="form-control form-control-user" name="ttl" title="Tanggal Lahir Anda" value="<?=$row['ttl'];?>" >
                      </div>
                    </div>
                    <div class="form-group row">
                    <div class="col-sm-6 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="provinsi" placeholder="Provinsi" title="Provinsi Anda" value="<?=$row['provinsi'];?>" >
                      </div>
                      <div class="col-sm-6">
                        <input type="text" class="form-control form-control-user" name="alamat" placeholder="Alamat" title="Alamat Anda" value="<?=$row['alamat'];?>" >
                      </div>
                    </div>

                    <div class="form-group">
                      <input type="email" class="form-control form-control-user" name="email" placeholder="Alamat Email" title="Alamat Email Anda" value="<?=$row['email'];?>" >
                    </div>
