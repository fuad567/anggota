...
<head>
  ...
  <title>Ubah Password - Ketua - Asosiasi Web Programmer</title>
            ...
            <div class="col-md-12 mb-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-primary">Perbarui Password untuk Keamanan</h6>
                </div>

                <div class="card-body">

                  <form class="user" action="../../controller/ketua/update_password.php" method="post">
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <input type="text" class="form-control form-control-user" name="nik" title="NIK Anda" value="<?=$row['nik'];?>" readonly placeholder="NIK" hidden>
                        <input type="password" class="form-control form-control-user" name="passwordlama" placeholder="Masukkan Password Lama">
                      </div>
                    </div>
                    
                    <div class="form-group row">
                      <div class="col-sm-12">
                        <input type="password" class="form-control form-control-user" name="passwordbaru" placeholder="Masukkan Password Baru">
                      </div>
                    </div>
