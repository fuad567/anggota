...
<head>
  ...
  <title>Login - Asosiasi Web Programmer</title>
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <div class="card o-hidden border-0 shadow-lg my-5">
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block" style="background: url(../assets/img/dts1.jpg);background-position: center;background-size: cover;"></div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang Asosiasi Web Programmer Indonesia!</h1>
                  </div>
                  <form class="user" action="../controller/login_action.php" method="post" onSubmit="return validasi()">
                    <div class="form-group">
                      <input type="text" class="form-control form-control-user" name="nik" placeholder="Masukkan NIK Anda..." required="">
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="daftar_anggota.php">Daftar Jadi Anggota!</a>
                  </div>
                </div>
              </div>
            </div>
