...
<head>
  ...
  <title>Portofolio - Anggota - Asosiasi Web Programmer</title>
            ...
            <div class="col-md-12 mb-4">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  ...
                  <form class="user" action="../../controller/anggota/update_portofolio.php" method="post">
                    ...
                    <div class="form-group row">
                      <div class="col-sm-12 mb-3 mb-sm-0">
                        ...
                        <input type="text" class="form-control form-control-user" name="bidang_keahlian" title="Bidang Keahlian Anda" value="<?php if($row2['Bidang_Keahlian'] == ' ') {echo ''; } else { echo $row2['Bidang_Keahlian']; } ?>" placeholder="Bidang Keahlian">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-12 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="riwayat_keahlian" title="Riwayat Keahlian Anda" value="<?php if($row2['Riwayat_Keahlian'] == ' ') {echo ''; } else { echo $row2['Riwayat_Keahlian']; } ?>" placeholder="Riwayat Keahlian">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-12 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="sertifikat_dimiliki" title="Sertifikat yang Anda Miliki" value="<?php if($row2['Sertifikat_Dimiliki'] == ' ') {echo ''; } else { echo $row2['Sertifikat_Dimiliki']; } ?>" placeholder="Sertifikat Dimiliki">
                      </div>
                    </div>
                    <div class="form-group row">
                      <div class="col-sm-12 mb-3 mb-sm-0">
                        <input type="text" class="form-control form-control-user" name="riwayat_project" title="Riwayat Project Anda" value="<?php if($row2['Riwayat_Project'] == ' ') {echo ''; } else { echo $row2['Riwayat_Project']; } ?>" placeholder="Riwayat Project">
                      </div>
                    </div>
